...
_RETIRED = {
    "legislatorByBioguideId": {
        "bioguideId": "R000001", "firstName": "Ret", "middleName": None,
        "lastName": "Ired", "nameSuffix": None, "nickname": None,
        "officialFull": "Ret Ired", "birthday": "1950-01-01", "gender": "M",
        "legislatorTermsByBioguideIdList": [
            {"termType": "sen", "party": "Democrat", "state": "CA",
             "district": None, "startDate": "1999-01-06", "endDate": "2001-01-03",
             "how": "election", "caucus": None},
            {"termType": "sen", "party": "Democrat", "state": "CA",
             "district": None, "startDate": "2001-01-03", "endDate": "2003-01-03",
             "how": "election", "caucus": None},
        ],
    }
}
...
async def test_current_is_null_when_every_term_has_ended(client, mock_graphql, govql_endpoint):
    mock_graphql.post(govql_endpoint).mock(
        return_value=graphql_response(data=_RETIRED)
    )
