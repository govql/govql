-- =============================================================================
-- V001 — Baseline schema (Flyway)
--
-- Consolidated initial schema for the us-congress database: the verbatim
-- contents of the former db/001-schema.sql + db/002-member-party-agreement.sql.
-- This is the Flyway baseline. Existing databases were adopted with
-- `flyway baseline -baselineVersion=1`; fresh databases run this from scratch.
--
